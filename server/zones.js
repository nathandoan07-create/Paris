...
const ZONES = [
  ...
  { id: "bosquet-bis", name: "Toit Bosquet · II", area: "Champ-de-Mars (7e)", lat: 48.8598, lng: 2.3020, radius: 115,
    ...
    desc: "Accès guidé le jour J : un hôte vous conduit sur le toit.",
    tags: ["Guidé"], address: "14 bis avenue Bosquet, 75007 Paris", access: { method: "Accompagné", value: "", note: "" } },
  { id: "bosquet-33", name: "Toit Bosquet · III", area: "Champ-de-Mars (7e)", lat: 48.8580, lng: 2.3010, radius: 120,
    price: 15, capacity: 2, left: 2, stars: 5, view: "Meilleure vue Tour Eiffel",
    desc: "Accès guidé le jour J : un hôte vous conduit sur le toit.",
    tags: ["Guidé"], address: "33 avenue Bosquet, 75007 Paris", access: { method: "Accompagné", value: "", note: "" } },
